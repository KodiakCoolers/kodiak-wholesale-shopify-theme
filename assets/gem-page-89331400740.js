    ...
    (function( jQuery ){
  var $module = jQuery('#m-1687235766082').children('.module');
  $module.gfV3Product();
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1687235766192').children('.module');
  ...
  switch(style) {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1687235766146').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1687235766108').children('.module');
  $module.gfV4ProductImageList({
    onImageClicked: function(imageUrl, imageZoomUrl) {}
  });
  ...
  jQuery(function() {
            var $module = jQuery('#m-1715712670241').children('.module');
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1715712986614').children('.module');
  $module.gfV1Popup();

  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  if(mode == 'dev') {
    var moduleId = "1715712986614";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1715712986614") {
      window.getPopup1715712986614 = function() {
...
(function( jQuery ){
  var $module = jQuery('#m-1715713144861').children('.module');
  $module.gfV2HeroBanner({});
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1718738129271').children('.module');
